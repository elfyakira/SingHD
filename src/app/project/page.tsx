...
const groupCompanies = [
  ...
  },
  {
    ...
    description:
      '株式会社Sing.nexTは、人財コンサルティングおよび採用支援を軸とする会社です。企業の組織課題に対して、より実行力にフォーカスした支援を行い、成長企業の加速と次世代リーダーの創出に貢献します。単なる採用代行にとどまらず、戦略設計から現場実装までを一貫して担うことで、企業の未来を支える人財基盤を構築します。',
    businessContent:
