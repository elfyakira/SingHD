...
export const recruitChapters: RecruitChapter[] = [
  { id: 'top', number: '①', title: 'TOP', titleEn: 'TOP', href: '/recruit', phase: 'hook' },
  { id: 'brand-story', number: '②', title: 'ブランドストーリー', titleEn: 'BRAND STORY', href: '/recruit/about#brand-story', phase: 'hook' },
  { id: 'founder', number: '③', title: '創業ストーリー', titleEn: 'FOUNDER STORY', href: '/recruit/about#founder', phase: 'empathy' },
  { id: 'letter', number: '④', title: '子供への手紙', titleEn: 'LETTER', href: '/recruit/about#letter', phase: 'empathy' },
  { id: 'sing-name', number: '⑤', title: 'Singという名前', titleEn: 'OUR NAME', href: '/recruit/about#sing-name', phase: 'empathy' },
  { id: 'mission', number: '⑥', title: '企業理念', titleEn: 'MISSION & VISION', href: '/recruit/mission', phase: 'empathy' },
  { id: 'last-boss', number: '⑦', title: 'ラスボス', titleEn: 'LAST BOSS', href: '/recruit/last-boss', phase: 'growth' },
