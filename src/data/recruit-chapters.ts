...
export const recruitChapters: RecruitChapter[] = [
  ...
  { id: 'brand-story', number: '②', title: 'ブランドストーリー', titleEn: 'BRAND STORY', href: '/miraiku/recruit/brand-story', phase: 'hook' },
  { id: 'founder', number: '③', title: '創業ストーリー', titleEn: 'FOUNDER STORY', href: '/miraiku/recruit/founder', phase: 'empathy' },
  { id: 'letter', number: '④', title: '子供への手紙', titleEn: 'LETTER', href: '/miraiku/recruit/letter', phase: 'empathy' },
  { id: 'sing-name', number: '⑤', title: 'Singという名前', titleEn: 'OUR NAME', href: '/miraiku/recruit/sing-name', phase: 'empathy' },
  ...
  { id: 'message', number: '⑫', title: '最後のメッセージ', titleEn: 'LAST MESSAGE', href: '/miraiku/recruit/message', phase: 'apply' },
  { id: 'jobs', number: '⑬', title: '募集要項', titleEn: 'RECRUIT', href: '/miraiku/recruit/jobs', phase: 'apply' },
]
